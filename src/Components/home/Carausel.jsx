...
const Carausel = () => {
     ...
     useLayoutEffect(() => {
        const track = document.querySelector(".moveLeft")
  ...
  return (
    <div className='overflow-hidden'>
            <div className='moveLeft flex w-max gap-10'>
...
>                     <div className='w-full'>
                   ...
                   <div className='w-full h-full items-center flex justify-center '>
                     <span className='font-[font1] text-gray-600  text-3xl text-nowrap font-light font-serif   '>
                        {industry.name}
                    </span>
                   </div>
